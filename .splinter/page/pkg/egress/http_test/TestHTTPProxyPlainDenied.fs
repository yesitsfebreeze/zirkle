// §head page/pkg/egress/http_test.go:77-95 TestHTTPProxyPlainDenied
// §sig func TestHTTPProxyPlainDenied(t *testing.T)
...
// §foot page/pkg/egress/http_test.go TestHTTPProxyPlainDenied